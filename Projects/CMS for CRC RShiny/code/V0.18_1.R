...
ui <- fluidPage(
  shinyjs::useShinyjs(),
  titlePanel(h1("SiSP Colorectal Cancer Subtyping Platform V 0.18", align = "center"),
             windowTitle = "SiSP Colorectal Cancer Subtyping Platform V 0.18"),
