...
tcga.ref_fs <- readRDS(file = "FS-CRC-TCGA_log2TPM_456samples.rds")
...
si.test_fs <- readRDS(file = "FS-CRC-SIRIRAJ_RSEM-TPM_3samples.rds")
...
si.test_umap <- data.frame(predict(tcga.ref_umap, 
                                   si.test_df["TBi_RNA02", ]))
